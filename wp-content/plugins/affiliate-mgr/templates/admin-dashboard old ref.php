   ...
   <h1><?php esc_html_e('Affiliate Manager Dashboard', 'affiliate-manager'); ?></h1>
    ...
    <thead>
        <tr>
            ...
            <th title="The name of the campaign that this link falls under"><?php esc_html_e('Campaign', 'affiliate-manager'); ?></th>
            ...
            <th title="Where the hit was before"><?php esc_html_e('Source', 'affiliate-manager'); ?></th>
            <th title="Any QR code that has been created for this link"><?php esc_html_e('QR Code', 'affiliate-manager'); ?></th>
        </tr>
    </thead>
    <tbody>
